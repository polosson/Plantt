...
planttEx.controller("planttExample", function($scope){
	...
	$scope.events = [
		...
		{ id: 4, title: 'Gniuk', type: 'urgent', startDate: new Date(2016, 7-1, 17, 8), endDate: new Date(2016, 7-1, 22, 19) },
		{ id: 5, title: 'Gnark Gnark Gnark Gnark Gnark Gnark Gnark', type: 'urgent', startDate: new Date(2016, 7-1, 17, 8), endDate: new Date(2016, 7-1, 18, 19) },
		...
		{ id: 12, title: 'Aout Second one', type: 'urgent', startDate: new Date(2016, 8-1, 4, 8), endDate: new Date(2016, 8-1, 5, 19) },
		{ id: 13, title: 'Aout Third event', type: 'urgent', startDate: new Date(2016, 8-1, 8, 8), endDate: new Date(2016, 8-1, 10, 19) }
	];
});